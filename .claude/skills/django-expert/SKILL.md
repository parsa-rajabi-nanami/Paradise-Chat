...
- The task is frontend/React/Tailwind work → use the frontend skills/agent
- Writing Django Channels consumers, WebSocket, or Redis channel-layer logic
  (this skill covers REST/ORM, not the async real-time layer)
- Non-Django Python or general scripting
- Pure DevOps/deployment without Django code changes
